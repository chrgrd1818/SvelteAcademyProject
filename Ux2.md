# E-Learning Platform: Student Learning Flow (Detailed)

## Detailed Student Journey with Quiz & Progress Tracking
...
flowchart TD
    ...
    subgraph F [Quiz Attempt Flow]
        ...
        F3 --> F4["Review Before Submit<br/>(Flaged Questions)"]
...
1.  **Clear Branching Logic**: The diagram effectively separates the success and retry paths after a quiz attempt.
2.  **Visual Progress**: The "Course Progress Dashboard" node uses visual bars (███░░░) to immediately convey completion status.
3.  **Contextual Feedback**: The results section provides score, analytics, and review capabilities in one view.
